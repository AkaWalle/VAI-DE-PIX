...
class _Body:
    """Simula SharedExpenseCreateSchema para testes (aceita list de dicts ou de schema)."""
    def __init__(self, amount, description, split_type="equal", invited_email=None, participants=None):
        self.amount = amount
