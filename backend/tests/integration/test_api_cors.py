...
class TestCORSConfiguration:
    ...
    def test_cors_preflight_any_vercel_subdomain(self):
        ...
        for origin in vercel_origins:
            ...
            assert response.status_code in [200, 204, 400, 405], f"Falhou para {origin}"
    ...
    def test_cors_allows_all_methods(self):
        ...
        for method in methods:
            ...
            assert response.status_code in [200, 204, 400, 405], f"Falhou para método {method}"
    ...
    def test_cors_allows_all_headers(self):
        ...
        for header in headers_list:
            ...
            assert response.status_code in [200, 204, 400, 405], f"Falhou para header {header}"
