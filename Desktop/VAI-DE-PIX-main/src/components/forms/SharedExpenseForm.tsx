...
export function SharedExpenseForm({ expenseId, onClose, onSuccess }: SharedExpenseFormProps) {
  const { 
    sharedExpenses, 
    categories, 
    addSharedExpense, 
          ...
          <div className="flex items-center justify-between">
            <div>
              <CardTitle className="flex items-center gap-2">
                ...
                {isEditing ? 'Editar Despesa Compartilhada' : 'Nova Despesa Compartilhada'}
              </CardTitle>
              <CardDescription>
                {isEditing ? 'Atualize os detalhes da despesa' : 'Crie uma nova despesa para dividir entre múltiplas pessoas'}
              </CardDescription>
            </div>
        ...
        <CardContent className="overflow-y-auto max-h-[calc(90vh-120px)] scrollbar-hide">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <Select value={formData.splitType} onValueChange={(value: any) => handleInputChange('splitType', value)}>
                <SelectTrigger>
                  <SelectValue />
                </SelectTrigger>
                <SelectContent>
            ...
            <div className="p-4 bg-muted/50 rounded-lg space-y-2">
              ...
              <div className="grid gap-2 text-sm">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="font-semibold">{formatCurrency(getTotalSplit())}</span>
                </div>
                <div className="flex justify-between">
                  <span>Diferença:</span>
                  <span className={`font-semibold ${getDifference() === 0 ? 'text-green-500' : 'text-red-500'}`}>
