...
export const transactionsService = {
  ...
  async createTransaction(transaction: TransactionCreate): Promise<Transaction> {
    try {
      apiHelpers.logRequest('POST', API_ENDPOINTS.transactions.create, transaction);
  ...
  // Update transaction
  async updateTransaction(id: string, updates: Partial<TransactionCreate>): Promise<Transaction> {
    try {
