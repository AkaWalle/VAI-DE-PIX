...
export default function SharedExpenses() {
  ...
  const getTotalPaid = (participants: any[]) => {
    return participants.reduce((sum, participant) => 
      participant.paid ? sum + participant.amount : sum, 0
    );
  };

  const getTotalAmount = (participants: any[]) => {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          <h1 className="text-3xl font-bold text-foreground">Despesas Compartilhadas</h1>
        ...
        <Card className="bg-gradient-card shadow-card-custom border-blue-500/20">
          ...
          <CardContent>
            <div className="text-2xl font-bold text-blue-500">
              {formatCurrency(sharedExpenses.reduce((sum, expense) => sum + expense.totalAmount, 0))}
            </div>
          </CardContent>
        </Card>
      </div>
      ...
      {sharedExpenses.length === 0 ? (
        <Card className="bg-gradient-card shadow-card-custom">
          <CardContent className="flex flex-col items-center justify-center py-12">
            ...
            <h3 className="text-xl font-semibold mb-2">Nenhuma despesa compartilhada</h3>
        ...
        <div className="grid gap-6">
          {sharedExpenses.map((expense) => {
            ...
            return (
              <Card key={expense.id} className="bg-gradient-card shadow-card-custom">
                <CardHeader>
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="grid gap-4 md:grid-cols-3">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <span className="font-semibold">{expense.participants.length}</span>
                    </div>
                    <div className="flex items-center gap-2">
                  ...
                  <div className="space-y-2">
                    <div className="flex justify-between text-sm">
                      ...
                      <span>{formatCurrency(totalPaid)} / {formatCurrency(totalAmount)}</span>
                    </div>
        ...
        <SharedExpenseForm 
          ...
          onSuccess={() => {
            ...
            toast({
              ...
              description: "A despesa compartilhada foi atualizada com sucesso.",
            });
          }}
        />
      )}
